  ...
  return (
    <Link href={href} className="relative inline-block">
      <button
        ...
        onClick={onClick}
        className="relative overflow-hidden my-[20px] py-[10px] px-[40px] bg-fanakaPrimary text-foreground cursor-pointer hover:text-background transition rounded-full shadow-xl"
      >
        <span
